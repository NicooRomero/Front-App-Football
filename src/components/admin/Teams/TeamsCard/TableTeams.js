    ...
    <>
      <div className="relative overflow-x-auto shadow-md sm:rounded-lg">
        <div className="flex items-center justify-between p-5 pb-4 bg-white dark:bg-gray-900">
          <div className="flex">
            <h1 className="text-3xl font-semibold whitespace-nowrap text-white">
              Registered Teams
            </h1>
            {user.isAdmin ? (
              <button
                type="button"
                onClick={() => addTeam()}
                className="focus:outline-none text-white bg-green-700 hover:bg-green-800 transition-all duration-300 font-medium rounded-lg text-sm px-5 py-2.5 ml-4 dark:bg-green-600 dark:hover:bg-green-700"
              >
